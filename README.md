...
## 目录
- 第1章：Go基础和概念（未译）
- [第2章：TCP和GO：扫描器和代理](ch-2/ch2-tcp-scanners-and-proxies.md )
- [第3章：HTTP客户端：使用工具远程交互.md](ch-3/ch3-http-clients-and-remote-interaction-with-tools.md)
- [第4章：HTTP服务器：路由和中间件](ch-4/ch4-http-servers-routing-and-middleware.md)
- [第5章：使用DNS：侦察等](ch-5/ch5-exploiting-dns.md)
